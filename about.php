...
@400;600&display=swap"
  ...
  <body>
    <div class="box">
      <img src="img/avatar.jpg" alt="User-Avatar" class="box-img" />
      
      <h1>Artem Pliusnin</h1>
      ...
      <ul>
        <li>
          <a href="#"
            ><i class="fa fa-facebook-square" ariahidden="true"></i
          ></a>
        </li>
        <li>
          <a href="#"><i class="fa fa-twitter-square" ariahidden="true"></i></a>
        </li>
        <li>
          <a href="#"
